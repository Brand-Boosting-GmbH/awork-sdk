...
export class MeTaskViews extends TaskViews {
     ...
     */
     ...
     async subscribe(taskViewId) {
          const response = await this._client.post(`me/taskviews/subscribe`, { taskViewId: taskViewId })
     ...
     async unsubscribe(taskViewId) {
          const response = await this._client.post(`me/taskviews/unsubscribe`, { taskViewId: taskViewId })
          return response.data()
     }
