...
exports.UserContactInfos = void 0;

require("../globalTypedef");

var _User = require("../model/User");

var _UserContactInfo = require("../model/UserContactInfo");
...
class UserContactInfos {
  ...
  */
  ...
  async get(contactInfoId) {
    ...
    return new _UserContactInfo.UserContactInfo(data);
  }
  /**
   * Returns the contact infos of the user with the specified id.
  ...
  async list(options) {
    ...
    const data = response.data();
    return data.map(d => new _UserContactInfo.UserContactInfo(d));
  }
  /**
...
exports.UserContactInfos = UserContactInfos;