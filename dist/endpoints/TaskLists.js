...
class TaskLists {
  ...
  async delete(taskListId, deleteTasks = false) {
    await this._client.post(`/${this._entityName}/${this._entityId}/tasklists/${taskListId}/delete`, {
  ...
  async updateOrder(taskListId, order) {
    await this._client.post(`/${this._entityName}/${this._entityId}/tasklists/${taskListId}/updateorder`, {
      order: order
    });
  }
  /**
