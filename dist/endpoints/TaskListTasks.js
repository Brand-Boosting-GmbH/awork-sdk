...
class TaskListTasks {
  ...
  async updateOrder(taskId, order) {
    const response = await this._client.post(`/${this._entityName}/${this._entityId}/tasklists/${this._taskListId}/tasks/${taskId}`, {
      order: order
    });
...
exports.TaskListTasks = TaskListTasks;