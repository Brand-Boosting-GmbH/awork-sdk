...
exports.ClientApplications = void 0;

require("../globalTypedef");

var _ClientApplication = require("../model/ClientApplication");
...
class ClientApplications {
  ...
  async get(clientId) {
    ...
    return new _ClientApplication.ClientApplication(data);
  }
  /**
  ...
  async list(options) {
    ...
    const data = response.data();
    return data.map(d => new _ClientApplication.ClientApplication(d));
  }
  /**
...
exports.ClientApplications = ClientApplications;